...
public class LessonService {
    ...
    public Lesson getLessonById(UUID lessonId) {
        try {
            ...
            throw new InternalServerErrorException("Failed to retrieve lesson", ex.getMessage());
        }
    }
    ...
    public int countExercisesInLesson(UUID lessonId) {
        try {
            ...
            throw new InternalServerErrorException("Failed to count exercises", ex.getMessage());
        }
    }
    ...
    public Lesson updateLesson(Lesson lesson) {
        try {
            ...
            throw new ConflictException("Lesson was modified by another user. Please refresh and try again.");
        } catch (DataIntegrityViolationException ex) {
            throw new BadRequestException("Invalid lesson data", ex.getMostSpecificCause().getMessage());
        } catch (DataAccessException ex) {
